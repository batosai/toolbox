<template>
  ...
  <div class="flex flex-col justify-center min-h-screen px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <svg class="w-64 mx-auto" viewBox="0 0 108 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
